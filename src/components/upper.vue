<template>
  <div class="upper" id="upper">
    ...
    <div class="div1">
      <h1 style="font-size: 32px; font-family: moderne">
        Get In Line For SilverLine
      </h1>
      <h3>
    ...
    <div class="div2">
      ...
      <!-- <div class="countdown-day">
        <h3 id="days" style="font-family: Avenir, Helvetica, Arial, sans-serif">
          00
        </h3>
      ...
      <div class="countdown-day">
        ...
        <h5 style="font-family: Avenir, Helvetica, Arial, sans-serif">
          Minutes
        </h5>
      </div>
      <div class="countdown-day">
